...
public class Reference
{
    ...
    public static final String MOD_NAME = "CUBG Additions Mod";
    public static final String MOD_VERSION = "1.3.0";
    public static final String MOD_COMPATIBILITY = "[1.12.2]";
    public static final String MOD_DEPENDS = "required-after:autoreglib@[1.3-18,);required-after:cgm@[0.4.3,)";
