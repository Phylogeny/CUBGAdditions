...
public class Reference
{
    ...
    public static final String MOD_DEPENDS = "required-after:obfuscate@[0.2.5,);required-after:cgm@[0.6.2,)";
    ...
    public static final String LINK_DISCORD = "https://discord.gg/gmcMRRk";
