...
public class GuiCubgMainMenu extends GuiCubg {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButtonCubg(BUTTON_LINK_WEBSITE, this.width - 83, 22, 80, 15, I18n.format("gui.button.website")).setDisabled(true));

		this.buttonList.add(new GuiButtonCubg(BUTTON_NEWS, this.width - 83, height - 18, 80, 15, I18n.format("gui.button.news")).setDisabled(true));
		...
		this.buttonList.add(new GuiButtonCubg(BUTTON_PLAY, 5, this.height - 35, 120, 30, I18n.format("gui.button.play")).setScale(2).setYOffset(-3).setImage(new ResourceLocation(Reference.MOD_ID, "textures/gui/menu/play.png")));

		this.buttonList.add(new GuiButtonCubg(BUTTON_BEAVER, 5, height - 80, 120, 15, I18n.format("gui.button.beaver")).setAlwaysHighlighted(designatedServerIP.equalsIgnoreCase(Reference.SERVERIP_BEAVER)));
		this.buttonList.add(new GuiButtonCubg(BUTTON_KANGAROO, 5, height - 60, 120, 15, I18n.format("gui.button.kangaroo")).setAlwaysHighlighted(designatedServerIP.equalsIgnoreCase(Reference.SERVERIP_KANGAROO)));
